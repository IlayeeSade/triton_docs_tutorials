...
# ==============================================================================
# 1. The Split-K GEMV Kernel (B=1 Dedicated)
# ==============================================================================
# ==============================================================================
# 1. The Split-K Vectorized GEMV Kernel
# ==============================================================================
@triton.autotune(
    configs=[
...
def _w4a16_gemv_splitk_kernel(
    ...
    # (Or use a separate kernel for bias, but this is simpler for now)
    if pid_k == 0:
...
def w4a16_gemv(W, b, S, Z, group_size, activations):
    ...
    # The grid is (Total Output Channels, Split-K factor)
